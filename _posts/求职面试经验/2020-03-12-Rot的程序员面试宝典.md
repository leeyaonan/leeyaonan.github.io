...
```java
public static String staticField = "静态变量";Copy to clipboardErrorCopied
static {
...
// CloneExample e2 = e1.clone(); // 'clone()' has protected access in 'java.lang.Object'Copy to clipboardErrorCopied
```
...
ac2.func1();Copy to clipboardErrorCopied
```
